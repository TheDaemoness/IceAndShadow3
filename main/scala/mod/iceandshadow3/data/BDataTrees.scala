...
abstract class BDataTreeBranch[Container, Key](c: Container) extends BDataTree(c) with Iterable[Key Tuple2 IDataTreeSerializable[_]] {
	...
	def get(key: Key): Option[IDataTreeSerializable[_ <: BDataTree[_]]]
}
