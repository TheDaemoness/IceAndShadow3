...
abstract class BWorldGenFeatureTypeBuilt[-ParentColumn <: TWorldGenColumnFn] (
	private val base: CanvasFeature
) extends BWorldGenFeatureType[TWorldGenColumnFn, ParentColumn](base.xWidth, base.zWidth) {
	type Analysis
