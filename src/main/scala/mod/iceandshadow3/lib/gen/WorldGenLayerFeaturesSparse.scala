...
/** Layer that generates structures that are positioned within a grid.
	...
	*/
abstract class WorldGenLayerFeaturesSparse[Column <: TWorldGenColumnFn: ClassTag, ParentColumn <: TWorldGenColumnFn](
	seed: Long, mod: Int, parent: TWorldGenLayer[ParentColumn], structType: WorldGenFeatureType[Column, ParentColumn],
	variance: Int, margin: Int
) extends WorldGenLayerFeatures[Column, ParentColumn](parent, structType) {
